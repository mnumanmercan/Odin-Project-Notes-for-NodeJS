  ...
  <div class="page-wrapper">
    <div class="container">
        ...
        <div class="card-header">
          <div class="header-content">
            ...
            <div class="header-text">
              ...
              <p class="subtitle">Fikirlerinizi dünyayla paylaşın</p>
            </div>
          </div>
        </div>
      ...
      <div class="footer-info">
        ...
        <p>Postunuz yayınlandıktan sonra istediğiniz zaman düzenleyebilir veya silebilirsiniz.</p>
      </div>
    </div>
  </div>
</template>
...
const handleSubmit = async () => {
  ...
  try {
    ...
    if (response.data.success) {
      success.value = 'Post başarıyla oluşturuldu! Yönlendiriliyorsunuz...';
